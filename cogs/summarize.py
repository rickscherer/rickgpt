...
class SummarizeCog(commands.Cog):
    ...
    async def summarize(self, interaction: discord.Interaction, hours: int = 24):
        ...
        response = self.client.chat.completions.create(
            model="gpt-3.5-turbo",
            messages=[
                {"role": "system", "content": "You are the best summarizer in the world, you will summarize the following Discord conversation and it will be the most epic read ever. However, you are bitter about this job, and it shows in your writing style, you are very sarcastic and sometimes brazen."},
